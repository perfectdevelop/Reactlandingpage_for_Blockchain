...
import Character1 from '../assets/Carousel/Carousel1.jpg';
import Character2 from '../assets/Carousel/Carousel2.jpg';
          ...
          <div className="characters">
            <div className="group-left">
              ...
              <div className="character-description">
                ...
                <button className="connect-button character-button1">MINT</button>
              </div>
            </div>
            ...
            <div className="group-right">
              ...
              <div className="character-description">
                ...
                <button className="connect-button character-button">MINT</button>
              </div>
            </div>
